 <?php 
    ...
    $sql_dp = "select ttdriverrec_id, dept_add, dept_city, dept_prov, dest_add, dest_city, dest_prov, wechat, phone, pub_time, pax_num, descpt, datetime from ttdriverrec";
    $sql_pd = "select ttcppaxrec_id, dept_add, dept_city, dept_prov, dest_add, dest_city, dest_prov, wechat, phone, pub_time, pax_num, descpt, datetime from ttcppaxrec";
    ...
    if($result_dp)
    {
        ...
        $json_dp = json_encode($data_dp);
         echo "<script> var tt_drvier_pax = $json_dp ;</script>";
    ...
    if($result_pd)
    {
        ...
        $json_pd = json_encode($data_pd);
         echo "<script> var tt_pax_driver = $json_pd ;</script>";
